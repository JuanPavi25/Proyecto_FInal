                    ...
                    <div className="row">
                        <div className="col-md-3 col-6">
                            <ul>
                                ...
                                <li>
                                    <a href="#ways">Formas de ver</a>
                                </li>
                                <li>
                                    <a href="#info">Información corporativa</a>
                                </li>
                                <li>
                        ...
                        <div className="col-md-3 col-6">
                            <ul>
                                ...
                                <li>
                                    <a href="#exclusive">Solo en Netflix</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-3 col-6">
                            <ul>
                                ...
                                <li>
                                    <a href="#redeem">Canjear tarjetas regalo</a>
                                </li>
                                <li>
                                    <a href="#privacy">Privacidad</a>
                                </li>
                                <li>
                                    <a href="#speed">Prueba de velocidad</a>
                                </li>
                                <li>
                                    <a href="#ads">Opciones de anuncios</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-3 col-6">
                            <ul>
                                <li>
                                    <a href="#press">Zona de prensa</a>
                                </li>
                                <li>
                                    <a href="#gift">Comprar tarjetas regalo</a>
                                </li>
                                <li>
                                    <a href="#cookies">Preferencias de cookies</a>
                                </li>
                                <li>
                                    <a href="#warranty">Garantía legal</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="row ps-4 pb-4">
                        <div className="col-lg-2 col-md-4 col-6">
                            <svg
                                ...
                                className="position-absolute mt-2 ms-2 default-ltr-cache-4z3qvp e1svuwfo1"
                                data-name="Languages"
                                aria-hidden="true"
                            >
                                <path
                            ...
                            <select className="form-select text-white text-center bg-black">
                                <option defaultValue>Español</option>
